  ...
  const experiences = [
    {
      ...
      description: 'Support development of strategies for managing a portfolio of $1M+ as a part of a student-managed CapitalFund Investment Team using Interactive Brokers, Docker and automated trading tools.\nBuild and refine the production tech stack and data flow, transforming Model State into Aggregate Optimized Positions for live portfolio execution. Developed model prototypes, including a momentum-based model for SPY with an MVO framework and a reinforcement learning model for global equities, as part of the team’s systematic strategy research.',
    ...
    },
    {
      ...
      period: 'Spet. 2025 - Present',
      description: 'Working as a team of 3 to build an AI-assisted research analyst tool that integrates financial APIs (Yahoo Finance), sentiment\nfeeds (Reddit, X), and financial news aggregators to automate equity research workflows for portfolio managers.Building a functional MVP in Python/Streamlit that retrieves, summarizes, and visualizes multi-source insights\n(fundamentals, earnings surprises, sentiment, and technical indicators), reducing manual research time by over 50%.',
    ...
    },
    {
      ...
      description: 'Help 600+ students understand object-oriented programming, data structures, recursion, and algorithm complexity during office hours and support development of debugging skills during the development of complex weekly projects.Promoted after mentoring Programming I class over the summer, leading 4 labs and office hours for 45+ students with\nminimal programming experience in concepts such as control flow, data types, functions and debugging',
